...
public class ITextPdfUtil {
    ...
    private  byte[] createPdfByCustom() {
        ...
        try {
            ...
            document.addTitle("龙湖保证金收款电子收据");
            document.addAuthor("无连接服务");
            document.addSubject("龙湖保证金收款电子收据");
            document.addCreator("songjisai");

            ClassPathResource resource = new ClassPathResource("static/images/image1.png");
            ...
            Paragraph block1 = new Paragraph("收款电子收据", titlefont);
            ...
            PdfPCell block2C4 = new PdfPCell(new Paragraph(DateUtil.format(new Date(), "yyyy- MM- dd"), textfont));
            ...
            Paragraph block5 = new Paragraph("宋先生", textfont);
            block5.setAlignment(Element.ALIGN_LEFT);
            document.add(block5);

            Paragraph block6 = new Paragraph("大糊涂科技有限公司", textfont);
            block6.setAlignment(Element.ALIGN_LEFT);
            document.add(block6);

            Paragraph block7 = new Paragraph("合同编号：" + "HT202123456349172", textfont);
            block7.setAlignment(Element.ALIGN_LEFT);
            document.add(block7);

            Paragraph block8 = new Paragraph("合同名称：" + "大糊涂有限公司装修合同", textfont);
            ...
            PdfPCell block12C3 = new PdfPCell(new Phrase("2000.23", textfont));
            ...
            PdfPCell block13C4 = new PdfPCell(new Paragraph("￥" + "2000.230", textfont));
            ...
            Paragraph block14 = new Paragraph("大糊涂科技集团", titlefont);
            ...
            PdfPCell block15C3 = new PdfPCell(new Paragraph("此处加盖财务专用章", textfont));
