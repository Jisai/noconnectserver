package com.songj.organization.util.aop;
...
import com.songj.organization.service.ExceptionLogService;
import com.songj.organization.service.OperationLogService;
...
//    @Value("${version}")
     ...
     */
    @Pointcut("@annotation(com.songj.organization.annotation.OperLog)")
     ...
     */
    @Pointcut("execution(* com.songj.organization.controller..*.*(..))")
    ...
    public void saveOperLog(JoinPoint joinPoint, Object keys) {
        ...
        try {
            operlog.setOperId(IdUtil.fastUUID()); // 主键ID
            ...
            operlog.setOperUserId(" 请求用户ID"); // 请求用户ID
            operlog.setOperUserName("请求用户名称"); // 请求用户名称
            operlog.setOperIp("请求IP"); // 请求IP
    ...
    public void saveExceptionLog(JoinPoint joinPoint, Throwable e) {
        ...
        try {
            ...
            // 获取切入点所在的方法
            Method method = signature.getMethod();
            excepLog.setExcId(IdUtil.fastUUID());
            // 获取请求的类名
            String className = joinPoint.getTarget().getClass().getName();
            // 获取请求的方法名
            String methodName = method.getName();
            ...
            excepLog.setOperUserId("操作员ID"); // 操作员ID
            excepLog.setOperUserName("操作员名称"); // 操作员名称
            excepLog.setOperUri(request.getRequestURI()); // 操作URI
            excepLog.setOperIp("操作员IP"); // 操作员IP
